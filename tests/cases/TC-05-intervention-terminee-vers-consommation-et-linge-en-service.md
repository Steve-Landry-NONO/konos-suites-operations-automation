# TC-05 — Intervention terminée vers consommation et linge en service
...
Vérifier que le workflow **Intervention terminée vers consommation et linge en service** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les mouvements prévisionnels deviennent des consommations réelles.
- Le linge réservé passe en service.
- L’intervention est marquée comme traitée.
- Une relance ne recompte pas la consommation.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-05-...md`
- Captures : `docs/screenshots/TC-05/`
