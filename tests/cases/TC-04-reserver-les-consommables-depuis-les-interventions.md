# TC-04 — Réserver les consommables depuis les interventions

## Métadonnées

| Champ | Valeur |
|---|---|
| Domaine | Stock consommables |
...
Vérifier que le workflow **Réserver les consommables depuis les interventions** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les mouvements prévisionnels de consommables sont créés.
- Les quantités correspondent aux règles métier.
- Les mouvements sont reliés à la réservation ou à l’intervention.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-04-...md`
- Captures : `docs/screenshots/TC-04/`
