# TC-09 — Annulation ou no-show vers libération des stocks
...
Vérifier que le workflow **Annulation ou no-show vers libération des stocks** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les réservations prévisionnelles de linge sont annulées.
- Les réservations prévisionnelles de consommables sont annulées.
- Les mouvements historiques restent traçables.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-09-...md`
- Captures : `docs/screenshots/TC-09/`
