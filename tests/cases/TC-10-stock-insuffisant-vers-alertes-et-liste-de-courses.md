# TC-10 — Stock insuffisant vers alertes et liste de courses
...
Vérifier que le workflow **Stock insuffisant vers alertes et liste de courses** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les articles sous seuil sont détectés.
- Une alerte ou ligne de courses est créée par article.
- Les quantités ou écarts sont renseignés.
- Une alerte existante n’est pas dupliquée.
- Un article revenu au-dessus du seuil n’est plus signalé comme actif.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-10-...md`
- Captures : `docs/screenshots/TC-10/`
