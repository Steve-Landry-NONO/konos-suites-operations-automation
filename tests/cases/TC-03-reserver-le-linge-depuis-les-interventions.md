# TC-03 — Réserver le linge depuis les interventions
...
Vérifier que le workflow **Réserver le linge depuis les interventions** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les mouvements prévisionnels de linge sont créés selon les besoins.
- Chaque mouvement est relié à la réservation ou à l’intervention.
- Les quantités sont cohérentes avec le nombre de voyageurs et la configuration.
- Une relance ne duplique pas les réservations de linge.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-03-...md`
- Captures : `docs/screenshots/TC-03/`
