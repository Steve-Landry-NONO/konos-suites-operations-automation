# TC-15 — Gestion des incidents opérationnels
...
Vérifier que le workflow **Gestion des incidents opérationnels** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Une intervention avec incident génère ou met à jour une alerte.
- La priorité dépend du type d’incident.
- L’alerte est reliée à l’intervention et à la réservation.
- Le champ indiquant que Steve a été prévenu est mis à jour.
- Une relance met à jour l’alerte existante.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-15-...md`
- Captures : `docs/screenshots/TC-15/`
