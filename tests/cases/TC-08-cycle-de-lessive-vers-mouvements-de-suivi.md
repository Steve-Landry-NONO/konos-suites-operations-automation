# TC-08 — Cycle de lessive vers mouvements de suivi
...
Vérifier que le workflow **Cycle de lessive vers mouvements de suivi** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les mouvements de suivi du cycle sont créés.
- Les statuts de lavage progressent correctement.
- Le linge revient au stock propre après clôture.
- Une relance ne duplique pas les mouvements.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-08-...md`
- Captures : `docs/screenshots/TC-08/`
