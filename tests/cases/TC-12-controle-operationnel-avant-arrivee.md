# TC-12 — Contrôle opérationnel avant arrivée
...
Vérifier que le workflow **Contrôle opérationnel avant arrivée** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les réservations arrivant dans la fenêtre de contrôle sont analysées.
- Le score de préparation est calculé.
- Les anomalies manquantes sont listées.
- La réservation passe à Prêt uniquement si tous les contrôles sont satisfaits.
- Le workflow n’altère pas les réservations hors périmètre.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-12-...md`
- Captures : `docs/screenshots/TC-12/`
