# TC-11 — Modification réservation vers recalcul des besoins
...
Vérifier que le workflow **Modification réservation vers recalcul des besoins** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Une modification significative déclenche le recalcul.
- Les anciennes réservations prévisionnelles sont annulées.
- Les nouveaux besoins sont recréés.
- L’empreinte de besoins est mise à jour.
- Le recalcul est bloqué si l’intervention est déjà en cours ou terminée.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-11-...md`
- Captures : `docs/screenshots/TC-11/`
