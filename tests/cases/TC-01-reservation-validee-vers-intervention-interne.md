# TC-01 — Réservation validée vers intervention interne
...
Vérifier que le workflow **Réservation validée vers intervention interne** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Une intervention interne est créée pour une réservation confirmée.
- La relation vers la réservation est renseignée.
- Une seconde exécution ne crée pas de doublon.
- Une réservation annulée ou incomplète n’est pas traitée.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-01-...md`
- Captures : `docs/screenshots/TC-01/`
