# TC-02 — Synchronisation Interventions vers Missions intervenante
...
Vérifier que le workflow **Synchronisation Interventions vers Missions intervenante** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Une mission intervenante est créée depuis l’intervention éligible.
- La mission est reliée à l’intervention et à la réservation.
- Les dates, heures et consignes sont transférées.
- Une relance ne crée pas de mission en double.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-02-...md`
- Captures : `docs/screenshots/TC-02/`
