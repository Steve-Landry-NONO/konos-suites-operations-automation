# TC-16 — Résumé quotidien et tableau de pilotage
...
Vérifier que le workflow **Résumé quotidien et tableau de pilotage** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Un seul résumé est créé pour la journée.
- Le résumé consolide arrivées, départs, missions, anomalies, achats et lessives.
- Une seconde exécution met à jour le résumé existant.
- La priorité augmente si des anomalies critiques sont présentes.
- Les compteurs correspondent aux données Notion.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-16-...md`
- Captures : `docs/screenshots/TC-16/`
