# TC-13 — Alerte réservation non prête avant arrivée
...
Vérifier que le workflow **Alerte réservation non prête avant arrivée** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Une réservation proche de l’arrivée et non prête génère une alerte critique.
- L’alerte contient la réservation, la date, le score et les anomalies.
- Une alerte existante n’est pas dupliquée.
- Une réservation prête ne génère pas d’alerte.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-13-...md`
- Captures : `docs/screenshots/TC-13/`
