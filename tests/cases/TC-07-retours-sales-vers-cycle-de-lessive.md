# TC-07 — Retours sales vers cycle de lessive
...
Vérifier que le workflow **Retours sales vers cycle de lessive** exécute correctement sa logique métier, reste idempotent, ne crée pas de doublon et conserve une traçabilité exploitable dans Notion.
...
- Les retours de linge sale sont rattachés à un cycle de lessive.
- Un cycle existant éligible est réutilisé ou un cycle est créé selon la règle.
- Les mouvements sont liés au cycle.
- Une relance n’ajoute pas deux fois le même retour.
...
- Workflow : `workflows/...`
- Résultat : `tests/results/TR-07-...md`
- Captures : `docs/screenshots/TC-07/`
